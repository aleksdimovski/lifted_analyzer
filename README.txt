...
*  Set the Library Path variable in ~/.bashrc 
	...
	gedit ~/.bashrc"
	```
Then, set the Library Path by appending:  % first find the folder where libraries of apron are installed, e.g. "/home/vmcai2021/.opam/default/share/apron/lib" or "/home/username/.opam/system/share/apron/lib"
	```
